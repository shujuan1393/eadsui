...
public class UpdateCustomerOutletCount {
    ...
    public static boolean updateCustomerOutletCount(Connection conn) {
        try {
            ...
            HashMap<Integer, HashMap<String, Integer>> customerOutletCount = new HashMap<Integer, HashMap<String, Integer>>();
            HashMap<String, Integer> outletCount = new HashMap<String, Integer>();
            ...
            while (rs.next()) {
                ...
                if (custId == currentCustId) { //same customer
                    ...
                    if (currentCustId != 0) {
                        ...
                        outletCount = new HashMap<String, Integer>();
                    }
            ...
            while (iterator.hasNext()) {
                ...
                int custId = (Integer) iterator.next();
