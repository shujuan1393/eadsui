...
public class addToCart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (orders == null) {
                orders = new HashMap<CustPreferenceWithTags, Integer>();
            }
            String itemid = request.getParameter("item");
            String qty = request.getParameter("qty");
            
            ArrayList<CustPreferenceWithTags> recommend = (ArrayList) session.getAttribute("recommend");
            for (CustPreferenceWithTags c: recommend) {
                String id = c.getItem_id();
                
                if (id.equals(itemid)) {
                    orders.put(c, Integer.parseInt(qty));
                }
            }
